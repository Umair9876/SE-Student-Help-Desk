...
{{--                                      "{{$page->id}}"--}}
                                    ...
                                    <div class="form-group mt-4">
                                            <input type="text" class="form-control" name= "sub_name" value="{{$page->subject_name}}" placeholder="Introduction to ICT" required="required">
                                        </div>      
                                   
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="top_name" value="{{$page->topic_name}}" placeholder="Topic Name" required="required">
                                    </div>
                                    <div class="form-group">
                                        <textarea type="text" class="form-control" name="description" >{{$page->des_topic}}</textarea>
{{--                                        rows="3"--}}
{{--                                        <textarea type="text" class="form-control"  name="des_topic" value="{{$page->g_d_link}}" placeholder="Description of the Topic"></textarea>--}}
                                          </div>
                                          <div class="form-group">
                                            <input type="text" class="form-control" name="goo_link" value="{{$page->g_d_link}}" placeholder="google drive link" required="required">
                                        </div>
                                       <!-- file choosen -->
{{--                                       <div class="custom-file mb-3 filechange">--}}
{{--                                          <input type="file" value="{{$page->file_url}}" name="saqib" id="myFile">--}}
