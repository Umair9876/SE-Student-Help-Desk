        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 mt-5 stylefonta">
                    <h3 style="color: white; text-align: left;"><b>Edit The User Data</b></h3>
                ...
                <div class="col-md-4 mb-3">
                    <div class="row">
                        ...
                        <div class="conn text-center navrad pr-3 pl-3 mt-1 ml-3 mt-3">
                            ...
                            <a href="/home"><img src="/images/home-icon.png" class="inage mt-2" alt="no" width="40px" height="40px">
                     ...
                     <div class="col-lg-12 col-md-6 bg-light conrad">
                         <form action="{{route('update')}}" method="POST">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" name="email" value="{{$pages->email}}">
                                </div>
